...
public class ImageUtil {
    ...
    public static DisplayImageOptions initOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                //图片在网络加载时显示的默认图片
                .showImageOnLoading(R.drawable.camera) // resource or drawable
                //图片请求地址为空时显示的默认图片
                .showImageForEmptyUri(R.drawable.camera) // resource or drawable
                //图片加载失败时显示的默认图片
                .showImageOnFail(R.drawable.camera) // resource or drawable
